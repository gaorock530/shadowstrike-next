    ...
    return (
      <div className="baoming_body">
        ...
        <div className="relative_body">
          ...
          <a className="test_link" href={`/test?nickname=${this.props.query.nickname}&pic=${this.props.query.pic}&subscribe=${this.props.query.subscribe}&token=${this.props.query.token}`}></a>
        </div>
